      ...
      <section className="mx-auto max-w-3xl">
        ...
        <div className="mt-6 space-y-4">
          ...
          <SettingsSection title="Workflow">
            <SettingsRow
              label="Adaptateur"
              description="V1 utilise un adaptateur simulé (Mock)"
            >
          ...
          <SettingsSection title="Données">
            <SettingsRow
              ...
              description="SQLite locale via Turso/libSQL"
            >
              <span className="rounded-full bg-surface-2 px-3 py-1 text-sm text-text-muted">
                .data/duo.db
              </span>
          ...
          <SettingsSection title="À propos">
            <SettingsRow label="Version" description="DUO DEV FACTORY WEB">
              <span className="text-sm text-text-muted">V1.0.0 — Mock</span>
            </SettingsRow>
            <SettingsRow label="Mode" description="Utilisateur unique, pas d'authentification distante">
